  ...
  return (
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-b from-background to-background/80" style={{
			background: 'radial-gradient(circle at center, rgba(85, 40, 160, 0.86) 0%, rgba(20, 10, 60, 0.5) 75%, transparent 99%)'
		  }}>
        ...
        <div className="container px-4 md:px-6 relative z-10" >
          <div className="max-w-4xl mx-auto text-center space-y-6" >
            <motion.h1 
              ...
              className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80 pb-3 "
            >
              {title}
            </motion.h1>
            <motion.p 
      ...
      {isSinglePost ? (
        ...
        <section className="py-12 bg-background" style={{
          background: 'radial-gradient(circle at center, rgba(85, 40, 160, 0.76) 0%, rgba(20, 10, 60, 0.9) 85%, transparent 99%)'
          }} >
          <div className="container px-4 md:px-6">
